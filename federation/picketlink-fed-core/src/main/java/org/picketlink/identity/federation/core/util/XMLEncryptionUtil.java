...
public class XMLEncryptionUtil
{
         ...
         throws ProcessingException
   {
      ...
      //To allow decryption of EncryptedData being the root element
      if ( ENCRYPTED_DATA_LOCALNAME.equals(documentRoot.getLocalName())) {
    	  encDataElement = documentRoot;
      } else {
    	  encDataElement = getNextElementNode(documentRoot.getFirstChild());
      }
