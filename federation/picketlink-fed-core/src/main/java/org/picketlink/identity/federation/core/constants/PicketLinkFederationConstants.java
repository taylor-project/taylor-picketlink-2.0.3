...
public interface PicketLinkFederationConstants
{
   ...
   //Added encryption key configurations for EncryptedAttribute support. -CZ
   String ENCRYPTION_KEY_ALG = "enryptionKeyAlg";
   String ENCRYPTION_SIZE = "encryptionKeySize";
