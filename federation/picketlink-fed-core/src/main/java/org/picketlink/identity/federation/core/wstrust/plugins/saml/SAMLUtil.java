...
public class SAMLUtil
{
   ...
   /**
    * Converts an AttributeType instance to Element so that it can be encrypted as Encrypted Attribute.
    * 
    * @author Charles Zhao
    * @param attributeType
    * @return
    */
   public static Document toSAMLAttributeDocument(AttributeType attributeType) throws Exception {
      ByteArrayOutputStream baos = new ByteArrayOutputStream();
      BaseWriter writer = new BaseWriter(StaxUtil.getXMLStreamWriter(baos));
      writer.writeAttributeTypeWithNS(attributeType);
