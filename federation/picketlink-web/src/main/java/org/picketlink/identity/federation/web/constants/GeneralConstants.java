...
public interface GeneralConstants
{
   ...
   String SAML_ENTITIES_FILE_LOCATION =  "/WEB-INF/saml-entities.xml";
   ...
   String ENCRYPTING_SECRET_KEY = "ENCRYPTING_SECRET_KEY";
   
   String ENCRYPTING_SECRET_KEY_SIZE = "ENCRYPTING_SECRET_KEY_SIZE";
   
   String SENDER_ENCRYPTION_PUBLIC_KEY = "SENDER_ENCRYPTION_PUBLIC_KEY";
